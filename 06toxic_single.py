...
def main_loop(max_features, maxlen, memn, dropn):
    path = '../nocode/'
...
if __name__ == '__main__':
    print("outbatch: *************************************************************")
    print("outbatch: " + str(sys.argv[1:]))
    model = main_loop(int(sys.argv[1]), int(sys.argv[2]), int(sys.argv[3]), float(sys.argv[4]))
