...
embeddings_index = {}
f = codecs.open('./data/fasttext/wiki.simple.vec', encoding='utf-8')
for line in tqdm(f):
...
#load data
train_df = pd.read_csv('./data/jigsaw-toxic-comment-classification-challenge' + '/train.csv', sep=',', header=0)
test_df = pd.read_csv('./data/jigsaw-toxic-comment-classification-challenge' + '/test.csv', sep=',', header=0)
...
submission_df.to_csv("./data/cnn_fasttext_submission.csv", index=False)
